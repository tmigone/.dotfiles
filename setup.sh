...
brew cask install google-chrome spotify slack discord visual-studio-code flowdock balenaetcher transmission postman docker whatsapp battle-net twitch zoomus
